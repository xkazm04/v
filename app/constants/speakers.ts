...
export const profiles_speakers = [
  {
    id: '1',
    name: 'Alexandra Chen',
    position: 'Tech CEO & Innovation Speaker',
    avatar: '/api/placeholder/80/80',
    monthlyStatements: 47,
    monthlyStatus: 'clean' as const,
    truthScore: 94,
    trend: 'up' as const,
    category: 'Technology',
    specialties: ['AI Ethics', 'Future Tech', 'Leadership'],
    recentActivity: 'Last statement: 2 days ago',
    topicExpertise: 95,
    publicTrust: 89,
    mediaPresence: 76,
    consistencyScore: 91
  ...
  {
    id: '2',
    name: 'Senator Michael Torres',
    position: 'Senior Political Figure',
    avatar: '/api/placeholder/80/80',
    monthlyStatements: 83,
    monthlyStatus: 'mixed' as const,
    truthScore: 72,
    trend: 'down' as const,
    category: 'Politics',
    specialties: ['Healthcare Policy', 'Economic Reform', 'Environment'],
    recentActivity: 'Last statement: 4 hours ago',
    topicExpertise: 82,
    publicTrust: 67,
    mediaPresence: 94,
    consistencyScore: 69
  },
  {
    id: '3',
    name: 'Dr. Sarah Kim',
    position: 'Climate Science Advocate',
    avatar: '/api/placeholder/80/80',
    monthlyStatements: 23,
    monthlyStatus: 'clean' as const,
    truthScore: 97,
    trend: 'stable' as const,
    category: 'Science',
    specialties: ['Climate Change', 'Environmental Policy', 'Research'],
    recentActivity: 'Last statement: 1 week ago',
    topicExpertise: 98,
    publicTrust: 93,
    mediaPresence: 45,
    consistencyScore: 96
  },
  {
    ...
    position: 'Business & Finance Commentator',
    avatar: '/api/placeholder/80/80',
    monthlyStatements: 156,
    monthlyStatus: 'liar' as const,
    truthScore: 34,
    trend: 'down' as const,
    category: 'Business',
    specialties: ['Market Analysis', 'Crypto', 'Investment'],
    recentActivity: 'Last statement: 12 minutes ago',
    topicExpertise: 71,
    publicTrust: 28,
    mediaPresence: 89,
    consistencyScore: 31
  },
  {
    ...
    position: 'Educational Policy Expert',
    avatar: '/api/placeholder/80/80',
    monthlyStatements: 31,
    monthlyStatus: 'clean' as const,
    truthScore: 91,
    trend: 'up' as const,
    category: 'Education',
    specialties: ['Policy Reform', 'Student Rights', 'Academic Research'],
    recentActivity: 'Last statement: 3 days ago',
    topicExpertise: 94,
    publicTrust: 87,
    mediaPresence: 52,
    consistencyScore: 89
