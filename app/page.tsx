...
export default function Home() {
  ...
  return (
    <motion.div 
      className="flex relative min-h-scree"
      initial="hidden"
      animate="visible"
    ...
    >
      ...
      >
        ...
        {/* Content fade-out at bottom for better logo visibility */}
        <motion.div
          className="h-20 bg-gradient-to-t from-background to-transparent pointer-events-none"
          initial={{ opacity: 0 }}
