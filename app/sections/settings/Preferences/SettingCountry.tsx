...
import SettingCountryGrid from './SettingCountryGrid';
  ...
  return (
    <div>
      <div className="text-center mb-10">
        ...
        >
          Select regions for localized news content
          <span className="block mt-1 text-sm opacity-80">
            Multiple selections allowed • Choose specific regions or go global
          </span>
        </motion.p>
      </div>
