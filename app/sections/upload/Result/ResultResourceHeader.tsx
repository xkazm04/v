...
const ResultResourceHeader = ({
    ...
    // ✅ FIXED: Use the actual counts passed from parent
    const actualSupportingCount = supportingTotal;
    const actualContradictingCount = contradictingTotal;
    const calculatedTotal = totalSources;
    ...
    // Debug logging
    console.log('ResultResourceHeader data:', {
        supportingTotal,
        contradictingTotal,
        totalSources,
        parseSupportingPercentage,
        parseContradictingPercentage
    });
            ...
            <div className="space-y-3">
                ...
                <div className="h-3 sm:h-4 bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-full flex">
                        <motion.div
                            initial={{ width: 0 }}
                            animate={{ width: `${parseSupportingPercentage}%` }}
                        ...
                        <motion.div
                            initial={{ width: 0 }}
                            animate={{ width: `${parseContradictingPercentage}%` }}
                            transition={{ duration: 1, delay: 0.3 }}
                            style={{
                                background: isDark
                ...
                <div className="text-center">
                    <span className="text-xs sm:text-sm" style={{ color: colors.mutedForeground }}>
                        {calculatedTotal} total sources analyzed
                    </span>
                </div>
            </div>
        </div>
